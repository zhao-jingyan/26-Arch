...
static inline void print_help(const char *file) {
  ...
  printf("      --sdcard-image=FILE    use FILE as the simulated sdcard image\n");
    ...
    switch (o) {
      case 0:
        switch (long_index) {
          ...
          case 4: args.sdcard_image = optarg; continue;
          case 5: difftest_ref_so = optarg; continue;
          case 6: args.enable_diff = false; continue;
