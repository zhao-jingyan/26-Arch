...
package csr_pkg;
  ...
  parameter u64 SSTATUS_MASK = 64'h80000003000DE762;  // per RISC-V spec: SD+UXL[33:32]+SUM+MXR+XS+FS+SPP+UBE+SPIE+SIE
  parameter u64 MIP_MASK = 64'h333;
  parameter u64 MTVEC_MASK = ~(64'h2);
  parameter u64 MEDELEG_MASK = 64'h000000000000B3FF;  // sync exc delegation to S
  parameter u64 MIDELEG_MASK = 64'h0000000000000222;  // SSIP|STIP|SEIP delegation to S
